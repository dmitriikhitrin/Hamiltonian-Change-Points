...
class Experiment:
    ...
    def _draw_psi0(self):
        if self.psi0_type == "random":
            return get_random_product_state(self.num_qubits)
        else:
            return get_random_clifford_product_state(self.num_qubits)
    ...
    def run(self,
        ...
        # Norm sweep
        self.norms = np.linspace(0, 0.5 * H_norm, self.num_norms)
